...
export function TrackPreview({ showPreview, setShowPreview, track }: TrackPreviewProps) {
  ...
  return (
    <Dialog open={showPreview} onOpenChange={() => setShowPreview(false)}>
      <DialogContent className="flex h-[96vh] max-h-[96vh] items-center gap-4">
        <div className="flex h-full w-full flex-col gap-4">
          <img
            src={track.image}
            className="h-[22vh] max-h-[165px] w-full rounded-lg object-cover sm:h-[27vh] sm:max-h-[225px] md:h-[30vh] md:max-h-[275px] lg:h-[35vh] lg:max-h-[300px] xl:max-h-[400px]"
          />
          <div className="flex flex-1 flex-col overflow-y-auto">
            ...
            <div className="flex w-full flex-col gap-4">
              ...
              <div className="mb-1 flex max-h-[25vh] w-full flex-col gap-3 overflow-y-auto py-2">
            ...
            <Link href={track.problems.length ? `/tracks/${track.id}/${track.problems[0]?.id}` : ""}>
              <Button
                size={"lg"}
                className="mt-1 flex items-center justify-center bg-blue-600 text-white transition-all duration-300 hover:bg-blue-500 lg:mt-0"
