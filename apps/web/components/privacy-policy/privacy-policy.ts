export const privacyPolicyContent = [
  ...
  {
    id: 19,
    description: "We use both session and persistent Cookies for the purposes set out below:",
  },
  {
    id: 20,
    description:
  ...
  {
    id: 21,
    description: "Use of Your Personal Data The Company may use Personal Data for the following purposes:",
  },
  {
    id: 22,
    description:
