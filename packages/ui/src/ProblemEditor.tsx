...
const data = [
    {
        id: 'wsefgrf1',
        title : 'Problem 1',
        description : 'This is a problem decription',
        notionId: '123'
    },
    {
        title : 'Problem 2',
...
useEffect(() => {
    (async ()=>{ 
       ...
       setProblems(problems.map((problem) => ({...problem, 'title' : 'this is a title'})));
    })()
},[])
...
// go to notion page
        ...
        >
           ...
           <div>
            {isEdit && <button className="p-1" style ={{ border : `1px solid white`}} onClick={async () => {
                // save
                setIsEdit(false);
                await editProblemFn({
                    problemId: problem
