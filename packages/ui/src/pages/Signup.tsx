                        ...
                        <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
                            <div className='bg-white py-12 px-4 shadow sm:rounded-lg sm:px-10'>
                                <div className='flex flex-col items-center justify-center gap-4'>
                                    ...
                                    <button
                                        type='submit'
                                        className='w-full flex justify-center items-center gap-2 py-3 px-4 border rounded text-gray-900 font-light text-md hover:bg-gray-200 focus:outline-none focus:ring-2 '
                                        onClick={() => onSignin()}
                                    >
                                    ...
                                    <button
                                        className='w-full flex justify-center items-center gap-2 py-3 px-4 border rounded text-gray-900 font-light text-md hover:bg-gray-200 focus:outline-none focus:ring-2 -mt-2'
                                    >
